...
import { Users2, Crown, ChevronDown, ChevronUp, Trash2 } from 'lucide-react';
...
export default function TeamsPage() {
  ...
  const deleteTeam = async (teamId: string, teamName: string) => {
    if (!confirm(`Delete team "${teamName}"?\n\nThis will:\n• Remove the team\n• Detach all members (they can join a new team)\n• Delete all pending invitations`)) return;
    try {
              ...
              <div key={team._id} className="glass rounded-2xl overflow-hidden animate-fadein">
                ...
                <div className="flex items-center">
                  <button
                    ...
                    className="flex-1 flex items-center justify-between p-5 hover:bg-white/3 transition-all text-left"
                  >
                  ...
                  <button
                    ...
                    className="p-5 text-red-400 hover:bg-red-500/10 transition-all border-l border-white/5 flex-shrink-0"
                    title="Delete team"
                  >
